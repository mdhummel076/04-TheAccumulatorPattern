...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 1
    answer = count_cosines_from(4, 9, 0.9)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 1
    answer = count_cosines_from(1, 2, 0.4)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 3
    answer = count_cosines_from(4, 8, 0.1)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 2
    answer = count_cosines_from(4, 12, 0.8)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 4
    answer = count_cosines_from(0, 7, 0.5)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 0.88452  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(4, 8)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 1.71786  # This is APPROXIMATELY the correct answer.
